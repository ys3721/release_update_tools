...
class MysqlInstaller(object):
    ...
    def prepare(self):
        ...
        os.system("cd /data0/src && rsync -avP 10.0.0.120::download/base/Percona-Server-5.5.25a-rel27.1-277.Linux.x86_64.tar.gz  /data0/src")
    ...
    def install(self):
        ...
        if self.instance_count == 1:
            os.system('rsync -avP 10.0.0.120::download/base/my.cnf.5.5 /etc/')
            os.system('mv /etc/my.cnf.5.5 /etc/my.cnf')
        elif self.instance_count == 2:
            os.system('rsync -avP 10.0.0.120::download/base/my.cnf.multi_two.5.5 /etc/')
            os.system('mv /etc/my.cnf.multi_two.5.5 /etc/my.cnf')
        else:
            os.system('rsync -avP 10.0.0.120::download/base/my.cnf.multi_four.5.5 /etc/')
