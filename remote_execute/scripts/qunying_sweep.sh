...
ssh $lan_ip "/usr/local/mysql/bin/mysql -uroot -P3306 -p123456 -h127.0.0.1 wg_lj_log -N -A -e \"select account_name,char_id,char_name,battle_big_type,template_id_or_bar_id from battle_log_2020_04_30 where battle_big_type='QUNYINGZHUAN' and battle_result = 'unknown' and battle_identify in (select battle_identify from battle_log_2020_04_30 where battle_big_type='QUNYINGZHUAN' and battle_result = '胜') ;\"";
